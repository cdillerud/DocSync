...
- The drop-zone arrow now renders as the intended symbol instead of mojibake such as ÃƒÂ¢Ã¢â‚¬Â¡Ã‚Â©.
- Document metadata separators now render as bullets instead of mojibake such as ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢.
