...
- The drop-zone arrow now renders as the intended symbol instead of mojibake such as Ã¢â€¡Â©.
- Document metadata separators now render as bullets instead of mojibake such as Ã¢â‚¬Â¢.
