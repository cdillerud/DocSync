...
$BackupRoot = Join-Path -Path $RepoRoot -ChildPath ".gpi-backups\line-grid-formatting-0270011-v4-$Timestamp"
...
try {
    ...
    Write-Host " GPI line-grid formatting pass 0.27.0.11 v4" -ForegroundColor Cyan
    Write-Host "============================================================" -ForegroundColor Cyan
