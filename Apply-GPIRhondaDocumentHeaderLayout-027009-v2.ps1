...
$BackupRoot = Join-Path -Path $RepoRoot -ChildPath ".gpi-backups\rhonda-document-header-layout-027009-v2-$Timestamp"
...
try {
    ...
    Write-Host " GPI Rhonda document header layout pass 0.27.0.9 v2" -ForegroundColor Cyan
    Write-Host "============================================================" -ForegroundColor Cyan
