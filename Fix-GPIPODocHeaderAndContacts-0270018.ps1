...
$BackupRoot = Join-Path -Path $RepoRoot -ChildPath ".gpi-backups\po-doc-header-and-contacts-0270018-$Timestamp"
...
try {
    ...
    Write-Host " GPI PO document header/contact cleanup 0.27.0.18" -ForegroundColor Cyan
    Write-Host "============================================================" -ForegroundColor Cyan
