...
$CandidateLayouts = Get-ChildItem -LiteralPath $ReportLayoutFolder -File -Filter "*.rdl" |
    Where-Object {
...
$BackupRoot = Join-Path -Path $RepoRoot -ChildPath ".gpi-backups\wrn-remove-expected-fields-0270020-v2-$Timestamp"
...
try {
    ...
    Write-Host " GPI Warehouse Receiving Notice remove Expected fields 0.27.0.20 v2" -ForegroundColor Cyan
    Write-Host "============================================================" -ForegroundColor Cyan
