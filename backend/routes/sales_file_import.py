"""
Sales file import (Excel/CSV) endpoints: parse, import orders/inventory,
sheet listing, column mappings, import history.

Extracted VERBATIM from server.py during the routes/ migration (see
MIGRATION_PROGRESS.md at repo root, Group 20). No logic changed.
"""
...
from services.file_ingestion_service import file_ingestion_service

router = APIRouter(prefix="/api")
logger = logging.getLogger(__name__)

@router.post("/sales/file-import/parse")
...
@router.post("/sales/file-import/import-orders")
...
@router.post("/sales/file-import/import-inventory")
...
@router.get("/sales/file-import/excel-sheets")
...
@router.get("/sales/file-import/column-mappings")
...
@router.get("/sales/file-import/history")
