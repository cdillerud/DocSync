...
async def _update_vendor_profile_incremental(db, doc_id: str, vendor_name: str, update_data: dict, final_status: str):
    """Incrementally update a vendor's intelligence profile after processing a document."""
    import re
    ...
    val_passed = (
        ...
        or status_lower in ("validationpassed", "validated", "storedinsp", "readytolink", "linkedtobc", "completed", "posted")
    )
