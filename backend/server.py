...
DEFAULT_JOB_TYPES = {
    ...
    "Shipping_Document": {
        ...
        "display_name": "Shipping Document",
        "category": "Sales",
        "automation_level": 0,
        "min_confidence_to_auto_link": 0.70,
        "min_confidence_to_auto_create_draft": 0.90,
        ...
        "required_extractions": [],
        "optional_extractions": ["tracking_number", "ship_date", "customer"],
        "keywords": ["ship", "shipping", "delivery", "dispatch", "release", "pick up", "bill of lading", "bol", "tracking"],
        "enabled": True
    },
    "Quality_Issue": {
...
async def shutdown_db_client():
    global _email_polling_task, _sales_polling_task
