...
async def decide_ap_route_with_learned_autonomy(
    ...
    **_: Any,
    ...
    result["authority_guard"] = {
        ...
        "exact_reference_current_ref_count": neighborhood.get("exact_reference_current_ref_count"),
        "exact_reference_match_count": neighborhood.get("exact_reference_match_count"),
