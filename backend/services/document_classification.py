"""
GPI Document Hub - Document Classification Service
...
Classification hierarchy:
  1. Zetadocs set code
  2. Square9 workflow name
  3. Mailbox category
  4. Legacy AI suggested_job_type
  5. AI classification (if enabled and doc_type is still OTHER)

Dependencies:
  - services.workflow_engine: DocType, DocumentClassifier
  - services.ai_classifier: classify_doc_type_with_ai
  - deps: AI_CLASSIFICATION_ENABLED, AI_CLASSIFICATION_THRESHOLD
"""
...
async def classify_document_type(
    ...
    if deps.AI_CLASSIFICATION_ENABLED and os.environ.get("EMERGENT_LLM_KEY"):
        ...
        try:
            ...
            if ai_result.should_accept(deps.AI_CLASSIFICATION_THRESHOLD):
                ...
                logger.info(
                    ...
                    document.get("id"), ai_result.proposed_doc_type, ai_result.confidence, deps.AI_CLASSIFICATION_THRESHOLD
                )
