...
import {
  LayoutDashboard, UploadCloud, Files, Settings, Moon, Sun, LogOut, Menu, X, ChevronRight, Brain, BarChart3, ShoppingCart, GitBranch, PieChart
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/workflow', icon: GitBranch, label: 'AP Workflow' },
