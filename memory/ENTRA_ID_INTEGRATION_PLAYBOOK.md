...
**Frontend (React CRA):**
- `@azure/msal-browser@^5.8.0` — core MSAL.
- `@azure/msal-react@^5.3.1` — React bindings (`MsalProvider`, hooks). **Amended 2026-04-23 from v2.0.0 → v3.1.0+ → ^5.3.1 (P1.K install-time correction; v5 explicitly peers React 19.2.1+).**
