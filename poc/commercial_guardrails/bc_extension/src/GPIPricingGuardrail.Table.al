table 70693 "GPI Pricing Guardrail"
{
    ...
    fields
    {
        ...
        field(5; "Rule Type"; Enum "GPI Pricing Rule Type")
        {
            Caption = 'Rule Type';
        }
    ...
    begin
        ...
        if ("Rule Type" = "GPI Pricing Rule Type"::"Fixed Price") and ("Locked Sell Price" <= 0) then
