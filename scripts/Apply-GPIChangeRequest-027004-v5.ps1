...
$PreviewPickTicketPattern = '(\r?\n\s*action\(GPIPreviewOwnedPickTicket\)\s*\{\r?\n)'
...
$BackupRoot = Join-Path $RepoRoot ".gpi-backups\change-request-027004-v5-$Timestamp"
...
try {
    ...
    Write-Host " GPI final change request 0.27.0.4 v5" -ForegroundColor Cyan
    Write-Host "============================================================" -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "The 0.27.0.4 v5 change-request build failed. Restoring all modified files." -ForegroundColor Red
