...
if ($null -eq $SuccessfulCandidate) {
    Write-Utf8NoBom -Path $PurchaseFile -Content $OriginalPurchase

    Write-Host ""
    Write-Host "No candidate compiled. The original Purchase Order file was restored." -ForegroundColor Red
