...
Write-Host 'V117_BAKEOFF_REV2_PYTEST_CWD=CANDIDATE_ROOT' -ForegroundColor Green
Write-Host 'V117_BAKEOFF_REV2_IMPORT_ORIGIN_ASSERTION=CONFIGURED' -ForegroundColor Green
