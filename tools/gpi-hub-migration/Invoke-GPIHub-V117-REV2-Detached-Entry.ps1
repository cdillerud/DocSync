...
$ExpectedFeatureCommit = '2f09075fb4e7eac3e9f7deac27bab8a0555d5471'
...
$EntryPatchTemplate = $EntryPatchTemplate.Replace('V117_FOCUSED_REGRESSION_TARGET=161','V117_FOCUSED_REGRESSION_TARGET=173')
