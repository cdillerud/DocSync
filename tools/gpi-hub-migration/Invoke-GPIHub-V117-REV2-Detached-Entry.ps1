...
$ExpectedFeatureCommit = '909ca17f19e13c831a6d0ffc2f3b898ce02966b7'
...
Require ($EntryPatchTemplate.Contains('__REPLAY_TRANSFORM_B64__')) 'V117 REV3 entry patch replay transform placeholder missing.'
...
$EntryPatchTemplate = $EntryPatchTemplate.Replace('V117_FOCUSED_REGRESSION_TARGET=161','V117_FOCUSED_REGRESSION_TARGET=174')
